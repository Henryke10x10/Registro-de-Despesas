...
function cadastrarDespesas() {
    ...
    if(despesa.validarDados()) {
        ...
        document.getElementById('modalTituloDiv').className = 'modal-header text-primary'
        ...
        document.getElementById('modal-conteudo').innerHTML = 'Verifique se todos os campos foram preenchidos'
        document.getElementById('modal-btn').innerHTML = 'Ok'
...
function corregaListaDespesas(despesas = Array(), filtro = false) {
    ...
    despesas.forEach(function(d) {
        ...
        btn.id = d.id
        btn.onclick = function modalExclusao() {
            document.getElementById('modalTitulo1').innerHTML = 'Despesa excluída!'
            document.getElementById('modalTituloDiv1').className = 'modal-header text-primary'
            document.getElementById('modal-conteudo1').innerHTML = 'Despesa excluída com sucesso'
            document.getElementById('modal-btn1').innerHTML = 'Ok'
            document.getElementById('modal-btn1').className = 'btn btn-primary'
...
function pesquisarDespesa() {
    ...
    corregaListaDespesas(despesas, true)
}
